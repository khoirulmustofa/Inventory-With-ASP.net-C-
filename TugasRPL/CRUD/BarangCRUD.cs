...
namespace TugasRPL.CRUD
{
    ...
    {
        public void Insert(BARANG barang)//---------UNTUK INSERT------------
        {
            string sql = @"insert into barang values(@0,@1,@2,@3,@4)";
            db.Execute(sql, barang.KODE_BARANG,
                            barang.NAMA_BARANG,
                            barang.STOK,
                            barang.HARGA,
        ...
        public void Inserts(BARANG b)
        {
            db.Insert("BARANG", "KODE_BARANG", false, b);
        }

        public void Update(BARANG barang)//---------UNTUK UPDATE------------
        {
            db.Update(barang);
        }
        ...
        {
            string sql = "DELETE FROM BARANG WHERE KODE_BARANG = @0";
            db.Execute(sql, id);
        }
