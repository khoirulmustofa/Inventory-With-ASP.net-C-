<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Detail.Master" AutoEventWireup="true" CodeBehind="LookupBarang.aspx.cs" Inherits="TugasRPL.Barang.LookupBarang" %>
            ...
            <div class="box dark">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <asp:GridView ID="gvLookupBarang" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbSelect" runat="server" class="btn btn-default btn-circle icon-check" OnClick="lbSelect_Click"
                                             CommandArgument='<%#Eval("KODE_BARANG")%>'>PILIH</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
